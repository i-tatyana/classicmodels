...
<%@ include file="/WEB-INF/layout/taglib.jsp"%>
 ...
 <div class="container">
    <div class="page-header">
 	...
 	<form:form commandName="customer" method="POST" action="/classicmodels/customers/customer/edit/${customer.customerNumber}.html" cssClass="form-horizontal editorialForm" >
