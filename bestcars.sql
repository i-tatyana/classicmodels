...
DROP TABLE IF EXISTS `bestcars`.`offices`;

CREATE TABLE `bestcars`.`offices` (
...
DROP TABLE IF EXISTS `bestcars`.`employees`;

CREATE TABLE `bestcars`.`employees` (
...
DROP TABLE IF EXISTS `bestcars`.`customers`;

CREATE TABLE `bestcars`.`customers` (
...
DROP TABLE IF EXISTS `bestcars`.`orders`;

CREATE TABLE `bestcars`.`orders` (
...
DROP TABLE IF EXISTS `bestcars`.`productlines`;

CREATE TABLE `bestcars`.`productlines` (
...
DROP TABLE IF EXISTS `bestcars`.`payments`;

CREATE TABLE `bestcars`.`payments` (
  `customerNumber` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `bestcars`.`products`;

CREATE TABLE `bestcars`.`products` (
...
DROP TABLE IF EXISTS `bestcars`.`orderdetails`;

CREATE TABLE `bestcars`.`orderdetails` (
  `orderNumber` int(11) NOT NULL,
  `productCode` varchar(15) NOT NULL,
