...
<c:forEach items="${user.categories}" var="category">
  <div class="tab-pane" id="category_${category.productLine}">
	<h1><c:out value="${category.htmlDescription}" /></h1>
	<p>
	
	<a href="<spring:url value="/category/remove/${category.productLine}.html" />" class="btn btn-danger triggerRemove">remove blog</a>
	
	<c:out value="${category.url}" /></p>
