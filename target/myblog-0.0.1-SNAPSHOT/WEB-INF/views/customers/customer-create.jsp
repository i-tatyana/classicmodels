 	...
 	<div class="row">
        <div class="col-md-6">
          <div class="well well-md">
			...
			<form:form commandName="customer" method="POST" action="/myblog/customers/customer/create.html" cssClass="form-horizontal" >
         ...
         <div class="col-md-4 col-md-offset-1">
           <div class="form-row">
             <form:form method = "GET" action = "/myblog/customers/register.html">
             <!-- 
